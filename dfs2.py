...
#     while True:
    ...
    if data1 == "Requesting files from server":
        xx=open("C:\Users\Snehpal\Desktop\ITP Semester 1\Data Communications 1\ProgramAssign4\Server2\Dennis\Recv_2.txt.1",'rb')
        r_xx=xx.read()
        print(r_xx)
        conn.send(r_xx)
        xy=open("C:\Users\Snehpal\Desktop\ITP Semester 1\Data Communications 1\ProgramAssign4\Server2\Dennis\Recv_2.txt.2",'rb')
        r_xy=xy.read()
        print(r_xy)
        conn.send(r_xy)
    else:
        ...
        print(sum)
        with open("C:\Users\Snehpal\Desktop\ITP Semester 1\Data Communications 1\ProgramAssign4\Server2\Dennis\Recv_2.txt.1",'wb') as fh:
            wr=fh.write(sum)
        msg=str(num)+'|||ACK'
        print (msg)
        ...
        print(sum1)
        with open("C:\Users\Snehpal\Desktop\ITP Semester 1\Data Communications 1\ProgramAssign4\Server2\Dennis\Recv_2.txt.2",'wb') as fh:
            wr=fh.write(sum1)
